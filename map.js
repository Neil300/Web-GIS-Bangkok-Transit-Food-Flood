/* ============================================================
   MAP INIT
============================================================ */
const map = L.map('map', { center:[13.76,100.54], zoom:11 });
...
function mkFoodPopup(f) {
  ...
  return `
    ...
    <div style="font-size:10px;color:#888;margin-top:7px;padding-top:7px;
                border-top:1px solid #2a2a4a">${f.desc}</div>
